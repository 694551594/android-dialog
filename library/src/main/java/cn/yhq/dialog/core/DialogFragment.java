...
public class DialogFragment extends android.support.v4.app.DialogFragment {
    ...
    private DialogBuilder.OnStateChangeListener getOnStateChangeListener() {
        DialogBuilder.OnStateChangeListener onStateChangeListener = ((cn.yhq.dialog.core.Dialog) dialog).getDialogBuilder().getOnStateChangeListener();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DialogBuilder.OnStateChangeListener onStateChangeListener = getOnStateChangeListener();
        if (onStateChangeListener != null) {
            onStateChangeListener.onSaveInstanceState(dialog, savedInstanceState);
        }
    }
}
